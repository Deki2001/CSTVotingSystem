...
public class DCC_Boys extends AppCompatActivity {


        @Override
        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            setContentView(R.layout.activity_dcc_boys);
            ...
            recyclerView = (RecyclerView)findViewById(R.id.DCCBoysrecyclerView);
            ...
            Query query = FirebaseDatabase.getInstance().getReference("Students").orderByChild("Role").equalTo("DCC");
...
//                  .build();
            ...
            recyclerView = findViewById(R.id.DCCBoysrecyclerView);
            recyclerView.setHasFixedSize(true);
            recyclerView.setLayoutManager(new LinearLayoutManager(this));

            candidateMdList = new ArrayList<CandidateModel>();
            Adapter = new VoteCandidateAdapter(DCC_Boys.this, candidateMdList);
