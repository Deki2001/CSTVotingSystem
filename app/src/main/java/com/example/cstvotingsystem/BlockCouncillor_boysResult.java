...
public class BlockCouncillor_boysResult extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_block_councillor_boys_result);
        ...
        recyclerView = (RecyclerView)findViewById(R.id.resultBlockCouncillorboysrecyclerView);
...
//                  .build();
        ...
        recyclerView = findViewById(R.id.resultBlockCouncillorboysrecyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        candidateMdList = new ArrayList<ViewResultModel>();
        Adapter = new ViewResultAdapter(BlockCouncillor_boysResult.this,candidateMdList);
