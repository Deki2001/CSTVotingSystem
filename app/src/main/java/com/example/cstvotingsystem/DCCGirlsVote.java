...
public class DCCGirlsVote extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        // platform.
        startActivity(new Intent(DCCGirlsVote.this, DCCGirlsVote.class));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dccgirls_vote);
        ...
        recyclerView = (RecyclerView)findViewById(R.id.DCCGirsVoterecyclerView);
...
//                  .build();
        ...
        recyclerView = findViewById(R.id.DCCGirsVoterecyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        candidateMdList = new ArrayList<CandidateModel>();
        Adapter = new VoteCandidateAdapter(DCCGirlsVote.this, candidateMdList);
        recyclerView.setAdapter(Adapter);

        FloatingActionButton floatingActionButton;

        floatingActionButton = findViewById(R.id.dccfloatingActionButton);

        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DCCGirlsVote.this, BlockCouncillorGirlsVote.class));
