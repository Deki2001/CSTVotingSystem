...
public class GamesCouncillorGirlsResult extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_games_councillor_girls_result);
        ...
        recyclerView = (RecyclerView)findViewById(R.id.GamesGirlsResult);
...
//                  .build();
        ...
        recyclerView = findViewById(R.id.GamesGirlsResult);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        candidateMdList = new ArrayList<ViewResultModel>();
        Adapter = new ViewResultAdapter(GamesCouncillorGirlsResult.this,candidateMdList);
