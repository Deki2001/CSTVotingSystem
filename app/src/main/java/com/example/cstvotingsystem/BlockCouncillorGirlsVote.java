...
public class BlockCouncillorGirlsVote extends AppCompatActivity {
    @Override
    ...
    public void onBackPressed() {
        ...
        // platform.
        startActivity(new Intent(BlockCouncillorGirlsVote.this, BlockCouncillorGirlsVote.class));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_block_councillor_girls_vote);
        ...
        recyclerView = (RecyclerView)findViewById(R.id.BCGirlsrecyclerView);
...
//                  .build();
        ...
        recyclerView = findViewById(R.id.BCGirlsrecyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        candidateMdList = new ArrayList<CandidateModel>();
        Adapter = new VoteCandidateAdapter(BlockCouncillorGirlsVote.this, candidateMdList);
        recyclerView.setAdapter(Adapter);

        FloatingActionButton floatingActionButton;
        floatingActionButton = findViewById(R.id.bcfloatingActionButton);
