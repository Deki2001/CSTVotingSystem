...
public class CACBoysResult extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cacboys_result);
        ...
        recyclerView = (RecyclerView)findViewById(R.id.CACBoysResult);
...
//                  .build();
        ...
        recyclerView = findViewById(R.id.CACBoysResult);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        candidateMdList = new ArrayList<ViewResultModel>();
        Adapter = new ViewResultAdapter(CACBoysResult.this,candidateMdList);
