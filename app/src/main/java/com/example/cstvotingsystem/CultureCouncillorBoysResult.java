...
public class CultureCouncillorBoysResult extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_culture_councillor_boys_result);
        ...
        recyclerView = (RecyclerView)findViewById(R.id.CultureBoysResult);
...
//                  .build();
        ...
        recyclerView = findViewById(R.id.CultureBoysResult);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        candidateMdList = new ArrayList<ViewResultModel>();
        Adapter = new ViewResultAdapter(CultureCouncillorBoysResult.this,candidateMdList);
