...
public class GamesCouncillorResult extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_games_councillor_result);
        ...
        recyclerView = (RecyclerView)findViewById(R.id.GamesBoysResult);
...
//                  .build();
        ...
        recyclerView = findViewById(R.id.GamesBoysResult);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        candidateMdList = new ArrayList<ViewResultModel>();
        Adapter = new ViewResultAdapter(GamesCouncillorResult.this,candidateMdList);
