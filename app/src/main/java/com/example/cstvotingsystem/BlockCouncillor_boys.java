...
public class BlockCouncillor_boys extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        // platform.
        startActivity(new Intent(BlockCouncillor_boys.this, CultureCouncillorBoys.class));
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_block_councillor_boys);
            ...
            recyclerView = (RecyclerView)findViewById(R.id.BlockCouncillorBoysrecyclerView);
...
//                  .build();
            ...
            recyclerView = findViewById(R.id.BlockCouncillorBoysrecyclerView);
            recyclerView.setHasFixedSize(true);
            recyclerView.setLayoutManager(new LinearLayoutManager(this));

            candidateMdList = new ArrayList<CandidateModel>();
            Adapter = new VoteCandidateAdapter(BlockCouncillor_boys.this, candidateMdList);
            recyclerView.setAdapter(Adapter);

            FloatingActionButton floatingActionButton;

            floatingActionButton = findViewById(R.id.boybcfloatingActionButton);
